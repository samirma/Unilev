...
contract SimpleTradeLong is TestSetup {
    function test__simpleTradeToCloseLong1() public {
        ...
        address tokenAddress = conf.supportedTokens[0].token;
        ...
        market.openPosition(tokenAddress, conf.supportedTokens[2].token, uint24(3000), false, 1, amount, 0, 0);
    ...
    function test__simpleTradeToCloseLong2() public {
        ...
        market.openPosition(tokenAddress, conf.supportedTokens[2].token, uint24(3000), false, 1, 10e8, 0, 0);
        ...
        assertEq(quoteToken_, conf.supportedTokens[2].token);
